...
client.on('message',async message => {
  ...
  if(message.content.startsWith(prefix + "معلومات رتبة")) {
...
client.login('NzQ5NDc3NjMyNzMwNTk1MzQw.X0sjcA.WVgR7QdAMUqCxvK-pqf4NB02nv0')//توكن بوتك
